// Package everyword marks every Pali word in the given DOM element. The onclick
// handler is also provided to handle click event of the word.
package everyword
...
// MarkEveryWord marks every Pali word in the given elemenet. The second
// argument is onclick handler of the word.
